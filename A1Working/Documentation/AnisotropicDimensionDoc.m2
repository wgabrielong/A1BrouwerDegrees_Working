...
document{
    ...
    Inputs => {
	GrothendieckWittClass => "beta" => {"denoted by ", TEX///$\beta\in\text{GW}(k)$///, ", where ", TEX///$k$///, " is the complex numbers, the real numbers, the rational numbers, or a finite field of characteristic not 2"},
	},
    Outputs => {
